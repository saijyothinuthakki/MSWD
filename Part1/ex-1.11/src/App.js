...
const Statistics = ({good ,bad,neutral ,total ,Average,positive}) => {
    ...
    return (
        <div>
           ...
           <tr><h4><Statastic value={good} text="good"/></h4></tr>         
            <tr><h4><Statastic value={neutral} text="neutral"/></h4></tr>                   
            <tr><h4><Statastic value={bad} text="bad"/></h4></tr>
            <tr><h4><Statastic value={total} text="total"/></h4></tr>
            <tr><h4><Statastic value={Average} text="Average"/></h4></tr>
            <tr><h4><Statastic value={positive+'%'} text="positive"/></h4></tr>
